...
class ApiResponse {
  ...
  constructor(isSuccess, statusCode, message: any, data = null) {
    ...
    message =
      typeof message === 'object'
        ? message.message !== null
          ...
          : message
        : message;
    const resMessage = responseMessages[message] ?? message;
   ...
   * @returns {ApiResponse}
   */
  static badRequest(message: any = 'Invalid request', data = null) {
